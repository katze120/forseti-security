...
class CaiApiClientImpl(gcp.ApiClientImpl):
    ...
    def iter_compute_addresses(self, project_number):
        ...
        address_resources = self._iter_compute_resources(
            'Address', project_number)

        global_address_resources = self._iter_compute_resources(
            'GlobalAddress', project_number)

        resources = itertools.chain(address_resources,
                                    global_address_resources)
